...
public class Principal {
	public static void main(String[] args) throws SQLException {
		...
		// //1. Igreja; 2. Congregação; 3. Congregação Presbiterial; 4. Campo
		// Missionário; 5. Ponto de Pregação
...
//		System.out.println(pessoa.toString());
		...
		// 1. Analfabeto; 2. Alfabetizado 3. Ensino Médio/Técnico; 4. Superior; 5.
		// Pós-Graduado
		...
		// //1.Solteiro; 2. Casado; 3. Divorciado; 4. Viúvo; 5. Separado; 6. União
		// Estável
		// nc.setConjugePessoa("");
		...
		// aviso.setConteudoAviso("Alterando o assunto alteramos o conteúdo dos
		// avisos");
		// aviso.setIdLider(1);
		...
		// System.out.println(avi2.getIdAviso() + "\t" + avi2.getOrigemAviso() + "\t" +
		// avi2.getDestinoAviso() + "\t" + avi2.getAssuntoAviso() + "\n" +
